 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 98.1}

#if ENABLED(K8_EXTRUDER)  //K8挤出机传功比
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100.5} //20230209 实际测量发现理论长度和实际出料长度不一致
#else  //精灵挤出机传功比
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.9} //20230209 实际测量发现理论长度和实际出料长度不一致
#endif
/**
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 50, 100 } // ...or, set your own edit limits
#endif
...
#if ENABLED(HIGH_SPEED_1) 
    #define MAX_ACCEL_EDIT_VALUES       { 12000, 12000, 800, 12000 } // ...or, set your own edit limits
  #else 
 ...
 */
#if ENABLED(HIGH_SPEED_1)
  #define DEFAULT_ACCELERATION          4000//1500//2000   // X, Y, Z and E acceleration for printing moves
  #define DEFAULT_RETRACT_ACCELERATION  4000//1500//2000   // E acceleration for retracts
  #define DEFAULT_TRAVEL_ACCELERATION   4000//1500//2000   // X, Y, Z acceleration for travel (non printing) moves
#else
...
// #define DEFAULT_TRAVEL_ACCELERATION   600   // X, Y, Z acceleration for travel (non printing) moves
  #define DEFAULT_ACCELERATION          1500//2000   // X, Y, Z and E acceleration for printing moves
  #define DEFAULT_RETRACT_ACCELERATION  1500//2000   // E acceleration for retracts
  #define DEFAULT_TRAVEL_ACCELERATION   1500//2000   // X, Y, Z acceleration for travel (non printing) moves
#endif
/**
...
#if ENABLED(K8_EXTRUDER)  //K8挤出机线序
 #define INVERT_E0_DIR true
#else                    //精灵挤出机线序
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT X_CENTER// AUTOZ_TOOL_X // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT Y_CENTER//Y_CENTER AUTOZ_TOOL_Y // Y point for Z homing
#endif
...
//
// Ender-3 V3 OEM display. A DWIN display with Rotary Encoder.
//
